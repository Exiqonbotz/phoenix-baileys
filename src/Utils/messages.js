        ...
        message.cards.map(async slide => {
            ...
            switch (buttonType) {                
                ...
                case "quick_reply":
                    ...
                    break;
                case "cta_copy":
                    buttonParamsJson = { display_text: buttonText, copy_code: buttonID };
                    break;
                case "cta_call":
                    buttonParamsJson = { display_text: buttonText, phone_number: buttonID };
                    break;
                case "cta_url":
                    buttonParamsJson = { display_text: buttonText, url: buttonID, merchant_url: buttonID };
                    break;
                case "cta_catalog":
                    buttonParamsJson = { business_phone_number: buttonID };
                    break;
                case "send_location":
                    buttonParamsJson = {};
                    break;
              ...
              messageContextInfo: {
                deviceListMetadata: {},
                  ...
                  interactiveMessage: WAProto_1.proto.Message.InteractiveMessage.fromObject({
                    contextInfo: message?.contextInfo || { mentionedJid: message?.mentions }, 
                      body: WAProto_1.proto.Message.InteractiveMessage.Body.fromObject({
                          text: message.text,
                      }),
                      footer: WAProto_1.proto.Message.InteractiveMessage.Footer.fromObject({
