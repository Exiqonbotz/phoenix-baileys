...
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/7ucg/baron-baileys/total)
...
Baileys and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/7ucg/baron-baileys/blob/main/LICENSE).
...
- [Baron-Api](https://baroapi--api--hf9nfmvp9f7y.code.run/)
- [Docs](https://7ucg.github.io/baron-baileys/)
...
await sock.sendMessage(
    jid,
    {
        text: 'Hi, this was sent using https://github.com/7ucg/baron-baileys'
    }
)
```
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/7ucg/baron-baileys/'}},
